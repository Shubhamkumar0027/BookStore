...
String endpoint="http://localhost:8082/mybooks/"+author+"/"+category;
...
RestTemplate bookSearchRest=new RestTemplate();
String endpoint="http://localhost:8082/mybook/"+bookId;
...
String priceEndpoint="http://localhost:8081/offeredPrice/"+bookId;
double offerPrice=bookPriceRest.getForObject(priceEndpoint, Double.class);
OrderItem item= new OrderItem(0, bookId, 1, bookId, offerPrice);
itemList.add(item);
...
Order order= new Order(totalQuantity, orderDate,"U-111",totalQuantity,totalPrice,"New");
OrderInfo orderInfo=new OrderInfo();
orderInfo.setOrder(order);
orderInfo.setItemsList(itemList);

//Invoke PlaceOrder MS
String orderEndpoint="http://localhost:8084/placeOrder";
...
public List<Order> getMyOrders(String userId) {
	// Invoke PlaceOrder MS
	String orderEndpoint = "http://localhost:8084/myorders/U-123";
	RestTemplate orderRest = new RestTemplate();
	...
	String ratingEndpoint="http://localhost:8083/addUserRating";
	...
	String ratingEndpoint="http://localhost:8083/userRatings/"+userId;
	RestTemplate ratingRest=new RestTemplate();
