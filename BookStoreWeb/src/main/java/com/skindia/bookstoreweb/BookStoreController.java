...
public String showBookFullInfo(@RequestParam("bookId") String bookId,HttpSession
...
public String removeBookFromCart(@RequestParam("bookId") String bookId,HttpSession
session) {
